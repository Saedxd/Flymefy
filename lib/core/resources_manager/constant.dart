...
// local Notification
  ...
  ///frontend/getDirectionsByCityId?city_id=
  static const String apiGetRegionsByCityId = '/frontend/getRegionsByCityId';
  ////frontend/getDirectionsByCityId?city_id=7
  static const String apiGetDirectionsByCityId =
      '/frontend/getDirectionsByCityId';
  static const String apiGetUnitSettingDetails =
      '/frontend/getUnitSectionsDetails';

  static const String apiGetCities = '/frontend/getCities';

  //apiAddUnit
  static const String apiAddUnit = '/unit/addUnit';

  static const String apiGetExtraOptionsByExtraId =
      '/frontend/getExtraOptionsByExtraId';
  static const String apiGetExtras = '/frontend/getExtras';
  static const String apiGetFeaturesByCategoryId =
      '/frontend/getFeaturesByCategoryId';
  static const String apiGetAmenitiesByCategoryId =
      '/frontend/getAmenitiesByCategoryId';
  static const String apiGetCategories = '/frontend/getCategories';

  //apiGetMyProperties
  static const String apiGetMyProperties = '/unit/getMyUnits';
  //apiGetPropertyDetails
  static const String apiGetPropertyDetails = '/unit/getMyUnitDetails';

  //apiUpdateUnavailableDate
  static const String apiUpdateUnavailableDate =
      '/unit/updateMyUnitUnavailableDates';
  //user/sendMessageToHelpCentre
  static const String apiSendMessageToHelpCentre =
      '/user/sendMessageToHelpCentre';

  // update
  static const String apiUpdateLocation =
      '/unit/updateMyUnitAddressInformation';

  ///frontend/getAllUnits

  static const String apiGetAllUnitsForTenant = '/frontend/getAllUnits';
  static const String apiGetPromoCode = '/user/getMyPromoCode';
  static const String apiActiveInsctivePromoCode =
      '/user/activeInactivePromoCode';
  static const String addPromoCode = '/user/addPromoCode';
//user/addPromoCode
  static const String apiGetReservations = "/user/getMyReservations";
  //apiGetReservationDetails
  static const String apiGetReservationDetails = "/user/getReservationDetails";
  //apiCheckOutBookingFinish
  static const String apiCheckOutBookingFinish = "/user/checkOut";

  ///user/getMyBookings?page_limit=1&page=1
  static const String apiGetMyBookings = "/user/getMyBookings";
  //{{url}}/user/getMyBookingDetails?reservation_id=2
  static const String apiGetMyBookingDetails = "/user/getMyBookingDetails";

  static const String apitoggleWishlist = "/user/toggleWishlist";

  static const String apiGetWishList = '/user/getMyWishlists';

  static const String apiGetSelfCheckIn = '/frontend/getSelfCheckIn';
  static const String apiGetTermsDetails = "/frontend/getTermsAndConditions";
  static const String apiGetPrivacyDetails = "/frontend/getPrivacyPolicy";
  static const String apiGetCancellationOfReservDetails =
      "/frontend/getCancellationPolicy";
  static const String apiGetinsuranceDetails = "/frontend/getInsurancePolicy";
  static const String apiGetPointsDetails = "/frontend/getPointBenefit";

  static const String apiUpdateMyUnitImages = '/unit/updateMyUnitImages';
  static const String apiUpdateMyUnitPrices = '/unit/updateMyUnitPrices';
  static const String apiUpdateMyUnitAmenities = '/unit/updateMyUnitAmenities';
  static const String apiUpdateMyUnitdetails = '/unit/updateMyUnitdetails';
  static const String apiUpdateMyUnitStatus = '/unit/updateMyUnitStatus';

  static const String apitUpdateUnitPrice = '/unit/updateMyUnitPrices';
  static const String apiGetUnitCalender = '/unit/getMyUnitCalendar';

  static const String apiToggleUnitUnavailableDate =
      '/unit/toggleUnitUnavailableDate';

  static const String apiGetNotification = '/user/getMyNotifications';
  static const String apiReadNotification = '';
  static const String apiDeleteNotification = '/user/getMyNotifications';
  static const String apiDeleteAllNotificaitons = '/user/deleteAllNotification';

  // static const String apiconfirmReservationPayment = '';
  static const String apiApproveOrRejectReservation =
      '/user/approveOrRejectReservation';

  static const String getChatsList = '/user/getUserChatRoomsWithDetails';
  static const String apiGetChatHistory =
      '/user/getMessagesByRoomId'; //apiSendMessage
  static const String apiSendMessage = "/user/chats/rooms/";
  // creeate provide
  static const String apiCreateRoom = "/user/chats/provide";
  static const String apiDeleteAccount = "/user/deleteMyAccount";

  static const String apiGetMyHelpCentreMessages =
      "/user/getMyHelpCentreMessages";

  static const String apiGetMyWalletBalanceWithdrawalRequests =
      "/user/getMyWalletBalanceWithdrawalRequests";

  static const String apiWalletBalanceWithdrawalRequest =
      "/user/walletBalanceWithdrawalRequest";
  static const String apiGetMyWalletTransactions =
      "/user/getMyWalletTransactions";

  static const String apiaddRatingUnit = "/user/addRatingUnit";
  static const String apideleteMyUnitImage = "/unit/deleteMyUnitImage";
  static const String apiGetPointsDetailsScreen = "/frontend/getPointsData";
  static const String apiGetPointsDescription = "/frontend/getCalculatePoints";

  static const String apiChangeUnitPrice = "/unit/updateMyUnitHolidayPrice";

  static const String apigetUnitStatuses = "/frontend/getUnitStatuses";

////////////////////////////////////////////////////////////////////
  static const String apiGetAllChatsForAllUnitsTenant =
      "/unit/tenantGetAllUnitsChat";

////////////////////////////////////////////////////////////////////
  static const String apiTenantGetUnitChatMessagesByUnitId =
      "/unit/tenantGetUnitChatMessagesByUnitId";

  static const String apiRentedGetUnitChatMessagesByChatId =
      "/unit/rentedGetUnitChatMessagesByChatId";

////////////////////////////////////////////////////////////////////
  static const String apiSendUnitMessageByTenant = "/unit/tenantSendUnitChat";
  static const String apiSendUnitMessageByRented =
      "/unit/rentedSendUnitChatByChatId";

  ////////////////////////////////////////////////////////////////////

  static const String apiGetAllChatsForConfirmedGuestsRented =
      "/unit/rentedGetConfirmedGuestsChat";

  static const String apiGetGeneralChatsForAllUnitsRented =
      "/unit/rentedGetAllUnitsChat";
...
UpdateUnitExtra
  */
  ...
  static const String apiUpdateUnitLocation =
      "/unit/updateMyUnitAddressInformation";
  static const String apiUpdateUnitImages = "/unit/updateMyUnitImages";
  static const String apiUpdateUnitSettings = "/unit/updateMyUnitSetting";
  static const String apiUpdateUnitFeatures = "/unit/updateMyUnitFeatures";
  static const String apiUpdateUnitExtra = "/unit/updateMyUnitExtras";
  static const String apiUpdateUnitAminites = "/unit/updateMyUnitAmenities";
  static const String apiUpdateUnitStatus = "/unit/updateMyUnitStatus";
  static const String apiUpdateUnitPrices = "/unit/updateMyUnitPrices";
  //apiUpdateUnitDetails
  static const String apiUpdateUnitDetails = "/unit/updateMyUnitdetails";
  static const String apiGetLateEntry = "/frontend/getLateEntry";
  static const String apiGetLastReviews = "/unit/getMyLatestUnitsReviews";
  static const String apiGetUnReadCount = "/user/getMyUnreadDataCount";
  static const String apigetReservationStatuses =
      "/frontend/getReservationsStatuses";
  static const String apigetfaqs = "/frontend/getfaqs";
  static const String apiGetComplainTypes = "/user/getComplaintTypes";
  static const String apiSendComplaint = "/user/sendComplaint";
  static const String apiCancelReservationTenant =
      "/user/cancelReservationByTenant";
  static const String apiCancelReservationRented =
      "/user/cancelReservationByRented";
  static const String apiUpdateTourismPermit = "/user/getMyWalletBalance";
}
