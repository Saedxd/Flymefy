...
import '../responseive_ui/responsive_provider.dart';
...
extension BuildContextValue on BuildContext {
  ...
  TextScaler get textScalar => MediaQuery.of(this)
      .textScaler
      .clamp(minScaleFactor: 0.5, maxScaleFactor: 1);
  ...
  // is English local
  bool get isEnglish =>
      read<LangaugeCubit>().state.locale == const Locale('en');
  bool get isArabic => read<LangaugeCubit>().state.locale == const Locale('ar');
