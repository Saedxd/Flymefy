...
class TravelersAndClassBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return 
    BlocBuilder<FlightBookCubit, FlightBookState>(
        bloc: cubit,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              TravelersCounter(
                value: (cubit.state.currentSelectedType == FlightType.oneWay
                    ? cubit.state.oneWayData.adults
                    : cubit.state.currentSelectedType == FlightType.roundTrip
                        ? cubit.state.roundTrip.adults
                        :  cubit.state.currentSelectedType == FlightType.multiCity
