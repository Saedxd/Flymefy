...
class OneWayCalender extends StatelessWidget {
  const OneWayCalender({Key? key, required this.cubit}) : super(key: key);
...
class OneWayCalenderScreen extends StatefulWidget {
  const OneWayCalenderScreen({
    Key? key,
    required this.cubit,
  }) : super(key: key);
  final FlightBookCubit cubit;
  ...
  @override
  State<OneWayCalenderScreen> createState() => _CalenderScreenState();
}

class _CalenderScreenState extends State<OneWayCalenderScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: [
              TableCalendar(
                ...
                onDaySelected: (selectedDay, focusedDay) {
                  widget.cubit.updateOneWaySelectedDay(selectedDay);
                },
