...
import 'package:flymefy/features/seats_meals/domain/repository/Seats_Meals_repository.dart';
...
class SeatsAndMealsRepositoryImpl implements SeatsAndMealsRepository {
  final ClientApi _authApi;
  final AppPreferences _appPreferences;
  final NetworkInfo _networkInfo;

  SeatsAndMealsRepositoryImpl(
