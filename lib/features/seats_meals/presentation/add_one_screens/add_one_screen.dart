          ...
          children: [
            ...
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Now travel worry free with Rs. 2,00,000 hospitalisation cover for ant COVID-19 variant and protect yourself from financial woes. valid for 6 days from trip date. TnC Apply",
                  style: TextStyle(
                    fontFamily: FontFamily.PoppinsRegular,
                    fontSize: 12,
                    color: black2E2,
