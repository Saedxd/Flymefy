    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: redCA0, width: 1.5)),
  ...
  static TextFormField3({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: white,
        contentPadding: const EdgeInsets.fromLTRB(0, 12, 5, 0),
        disabledBorder: UnderlineInputBorder(
            borderRadius: BorderRadius.circular(0),
            borderSide: const BorderSide(color: greyD4D, width: 0)),
  ...
  static TextFormField9({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: white,
        contentPadding: const EdgeInsets.fromLTRB(0, 26, 0, 0),
        disabledBorder: UnderlineInputBorder(
            borderRadius: BorderRadius.circular(0),
            borderSide: const BorderSide(color: greyD4D, width: 0)),
        border: UnderlineInputBorder(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: greyE2E, width: 1)),
        border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: const BorderSide(color: greyE2E, width: 1)),
        focusedBorder: OutlineInputBorder(
  ...
  static TextFormField5({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: const BorderSide(color: grey717, width: 1)),
        border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: const BorderSide(color: grey717, width: 1)),
        focusedBorder: OutlineInputBorder(
  ...
  static TextFormField7({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: UnderlineInputBorder(
            borderRadius: BorderRadius.circular(0),
            borderSide: const BorderSide(color: greyE8E, width: 0)),
        border: UnderlineInputBorder(
            borderRadius: BorderRadius.circular(0),
            borderSide: const BorderSide(color: greyE8E, width: 0)),
        focusedBorder: UnderlineInputBorder(
  ...
  static TextFormField8({controller, keyboardType, hintText, suffixIcon}) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: const BorderSide(color: greyE6E, width: 1)),
        border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: const BorderSide(color: greyE6E, width: 1)),
        focusedBorder: OutlineInputBorder(
